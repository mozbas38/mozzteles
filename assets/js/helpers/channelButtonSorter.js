...
export function saveOriginalOrder(containerId) {
    try {
        ...
        console.error('[teles] Hata in saveOriginalOrder:', e);
    }
}
...
function applySorting(containerId, compareFn) {
    try {
        ...
        console.error(`[teles] Hata sorting containers (${containerId}):`, e);
    }
}
...
export function restoreOriginalChannelButtonsOrder(containerId) {
    try {
        ...
        console.error('[teles] Hata in restoreOriginalChannelButtonsOrder:', e);
    }
}